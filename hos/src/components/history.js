...
const History = () => {
    ...
    return ( 
        <div className='History'>
            <Navigation />
            <div class="display-2 headerHistory">The Big Bang!</div>
            
            <div class="founderMessage">
               <img src={img1} class="img_position1"></img>
               Frosh week is when I knew this was something special. The stories, the people, and the diversity. 
               ...
               fits into the wholesome vibe, let’s do it.
               <img src={img2} class="img_position2"></img>
               At about the same time, I joined the Skulebook photography team. 
               ...
               We are the engineers. We are humans of Skule. - <span>Addy Batia (Mech 1T9 + PEY)</span>
            </div>
            <Footer />
        </div>  
    );
